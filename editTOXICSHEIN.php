...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['imagen'])) {
    ...
    if (move_uploaded_file($_FILES['imagen']['tmp_name'], $rutaCompleta)) {
        $stmt = $pdo->prepare("INSERT INTO toxicshein (ruta_imagen) VALUES (?)");
        $stmt->execute([$rutaBD]);
...
<h1>🧴 Panel de Edición - Productos de Limpieza</h1>
